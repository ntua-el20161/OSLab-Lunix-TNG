...
#define LUNIX_CHRDEV_BUFSZ      20      /* Buffer size used to hwold textual info */
#define TYPE(dev) (MINOR(dev) & 0x07)	/* Type of Masurement e.g. TEMP*/
#define NO(dev) (MINOR(dev) >> 3) 	/* Sensor number */
